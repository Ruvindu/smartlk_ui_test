...
public class EnvironmentConstants {
    ...
    public static final int DT_INIT_WAIT = 10;
...
//    public static String URL = "http://192.168.14.123/";
//    public static String URL = "http://sfc-cx-dev-trade.universal.directfn.net/";
